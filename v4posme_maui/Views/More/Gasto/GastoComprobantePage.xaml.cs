...
public partial class GastoComprobantePage : ContentPage
{
    private readonly GastoComprobanteViewModel _viewModel;

    public GastoComprobantePage()
    {
        InitializeComponent();
    ...
    // Bloquea el boton atras: solo se puede salir por Inicio o Nuevo Gasto.
